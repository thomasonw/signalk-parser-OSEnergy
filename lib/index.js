...
var deviceName = "???";	 	// Placeholder until we recevie a true device name from NPS; string.
var associatedBus = 0;		// Assume device is on DC bus 0 until updated from CST; string.
...
module.exports = {
  Parser: Parser,
  parse: parseLine,
  setDN: function(newDN) {deviceName = newDN},
  setAB: function(newAB) {associatedBus = newAB},
  getAB: function()      {return associatedBus}
